...
import NewSectionDialog from "../../../projects/boards/[boardId]/dialogs/NewSection";

import NewTaskInProjectDialog from "../../../projects/boards/[boardId]/dialogs/NewTaskInProject";
import { getActiveUsers } from "@/actions/get-users";
import { getBoardSections } from "@/actions/projects/get-board-sections";
import DeleteProjectDialog from "../../../projects/boards/[boardId]/dialogs/DeleteProject";
import { getKanbanData } from "@/actions/projects/get-kanban-data";
import Kanban from "../../../projects/boards/[boardId]/components/Kanban";
import Gantt from "../../../projects/boards/[boardId]/components/Gantt";

import ProjectEditPanel from "../../../projects/boards/[boardId]/components/ProjectEditPanel";
import ProjectDocumentsPanel from "../../../projects/boards/[boardId]/components/ProjectDocumentsPanel";
import { getBoards } from "@/actions/projects/get-boards";
import { getServerSession } from "next-auth";
import { authOptions } from "@/lib/auth";
import { Users } from "@prisma/client";
import AiAssistantProject from "../../../projects/boards/[boardId]/components/AiAssistantProject";
import BoardTabsContainer from "../../../projects/boards/[boardId]/components/BoardTabsContainer";
import ProjectMembersPanel from "../../../projects/boards/[boardId]/components/ProjectMembersPanel";
...
const CampaignBoardPage = async (props: BoardDetailProps) => {
    ...
    try {
        const brandRes = await fetch(`${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/api/projects/${boardId}/brand`, { cache: 'no-store' as any });
        if (brandRes.ok) {

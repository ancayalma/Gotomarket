...
const PLANS = [
    {
        ...
        name: "Free",
        monthlyPrice: 0,
        features: ["1 user", "50 MB storage", "500K AI tokens/mo", "100 LeadGen credits", "1,000 emails/mo"],
    ...
    },
    {
        ...
        monthlyPrice: 50,
        features: ["2 users", "5 GB storage", "5M AI tokens/mo", "1,000 LeadGen credits", "5,000 emails/mo", "5 active quests"],
        highlights: ["Everything in Free", "Documents & Invoicing", "Reports & AI Lab", "Email Campaigns", "Custom Themes"],
        icon: Zap,
        color: "indigo",
    ...
    },
    {
        ...
        name: "Individual Pro",
        monthlyPrice: 150,
        features: ["4 users", "50 GB storage", "20M AI tokens/mo", "5,000 LeadGen credits", "25,000 emails/mo", "25 active quests"],
        highlights: ["Everything in Basic", "All Premium Features", "Priority Support", "Advanced Analytics"],
        icon: Crown,
        color: "amber",
    ...
    },
    {
        ...
        name: "Enterprise",
        monthlyPrice: 0,
        features: ["Unlimited users", "Unlimited storage", "Unlimited AI tokens", "Unlimited LeadGen", "Unlimited emails", "Unlimited quests"],

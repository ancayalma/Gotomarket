...
npm run dev`}
                        ...
                        <div className="mt-16 p-8 rounded-2xl bg-cyan-500/5 border border-cyan-500/20 text-center">
                            ...
                            <div className="flex gap-4 justify-center flex-wrap">
                                <a href="https://github.com/BasaltHQ/crm-official" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-black font-bold rounded-full transition-all hover:bg-gray-200">
                                    Browse GitHub <Laptop className="ml-1 w-4 h-4" />
                                </a>
                                <a href="https://discord.gg/G9Sp8CAQmV" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded-full transition-all">
                                    Join Discord
                                </a>
                            </div>
                        </div>

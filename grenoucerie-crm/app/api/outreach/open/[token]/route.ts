...
export async function GET(
  ...
  try {
    ...
    // Find lead by open token (real leads only)
    ...
    if (lead && !lead.outreach_opened_at) {
    ...
    // Update outreach item + campaign stats (works for both real leads AND pool candidates)

...
export default async function ProductsPage() {
    ...
    return (
        <UpgradeGate featureId="products" title="Product Catalog Locked" description="The product catalog and SKU management module requires a Growth plan or higher.">
            <Container

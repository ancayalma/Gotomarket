            ...
            <div className="flex space-x-2">
              <Sheet open={open} onOpenChange={setOpen}>
                ...
                <SheetContent className="min-w-[500px] space-y-2">
                  <SheetHeader>
                    <SheetTitle className="text-xl md:text-2xl font-black bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent italic tracking-tight uppercase leading-relaxed py-2 px-2">Create new Task</SheetTitle>
                  </SheetHeader>

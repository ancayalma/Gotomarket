    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl md:text-5xl font-black bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent italic tracking-tight uppercase leading-relaxed py-4 px-4 mb-2">{objectDef.name} ({objectDef.apiName})</h1>
                ...
                <TabsContent value="fields" className="space-y-4 mt-4">
                    <div className="flex justify-between items-center">
                        ...
                        <Dialog open={isFieldModalOpen} onOpenChange={setIsFieldModalOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    <DialogTitle className="text-xl md:text-2xl font-black bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent italic tracking-tight uppercase leading-relaxed py-2 px-2">Create Custom Field</DialogTitle>

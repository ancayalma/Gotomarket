        ...
        return (
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className={cn("w-auto p-0 bg-zinc-950 border-white/10 max-w-[95vw]", popoverClassName)}>
                    <DialogTitle className="text-xl md:text-2xl font-black bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent italic tracking-tight uppercase leading-relaxed py-2 px-2">Select Date Range</DialogTitle>
                    {CalendarContent}
                </DialogContent>
            </Dialog>
        );
